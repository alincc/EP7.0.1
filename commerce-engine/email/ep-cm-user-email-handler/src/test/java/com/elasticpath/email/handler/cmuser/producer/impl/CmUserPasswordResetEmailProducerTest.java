...
public class CmUserPasswordResetEmailProducerTest {
	...
	@Before
	public void setUp() {
		emailProducer = new CmUserPasswordResetEmailProducer();
		...
		context.checking(new Expectations() {
			{
				...
				oneOf(cmUserEmailPropertyHelper).getResetEmailProperties(with(any(CmUser.class)), with(any(String.class)), with(any(Locale.class)));
