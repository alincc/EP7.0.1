...
/**
 * Creates an Order Shipment Release Failed {@link Email} for a given order shipment number.
 */
public class OrderShipmentReleaseFailedEmailProducer extends AbstractEmailProducer {
	...
	@Override
	public Email createEmail(final String shipmentNumber, final Map<String, Object> emailData) throws EmailException {
