...
/**
 * Producer for the customer registration email.
 */
public class CustomerRegistrationEmailProducer extends AbstractEmailProducer {
	...
	public Email createEmail(final String guid, final Map<String, Object> emailData) throws EmailException {
		...
		final EmailProperties customerEmailProperties = getCustomerEmailPropertyHelper().getNewAccountEmailProperties(customer);
