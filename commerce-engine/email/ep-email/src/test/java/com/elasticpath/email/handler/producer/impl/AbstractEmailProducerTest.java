...
/**
 * Test class for {@link AbstractEmailProducer}.
 */
public class AbstractEmailProducerTest {

	private AbstractEmailProducer abstractEmailProducer;

	@Test
	public void verifyCreateEmailsIsSimpleWrapperForCreateEmail() throws Exception {
		final Email email = new SimpleEmail();

		abstractEmailProducer = new AbstractEmailProducer() {
			@Override
