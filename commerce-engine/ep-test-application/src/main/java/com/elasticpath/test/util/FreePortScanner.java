 ...
 * 
 * ELASTIC PATH NOTE: This class has been copied from the spring-web test source. It can be removed
 * when/if Spring make it publicly accessible, see https://jira.springsource.org/browse/SPR-8032
 */
public final class FreePortScanner {
