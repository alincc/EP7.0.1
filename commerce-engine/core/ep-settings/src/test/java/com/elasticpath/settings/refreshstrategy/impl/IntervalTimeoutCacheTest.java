 ...
 */
public class IntervalTimeoutCacheTest {
	...
	public void testSimpleCaching() {
		...
		IntervalTimeoutCache<String, String> cache = new IntervalTimeoutCache<>(timeout);
	...
	public void testNormalCacheTimeout() {
		...
		IntervalTimeoutCache<String, String> cache = new IntervalTimeoutCache<String, String>(timeout) {
			@Override
