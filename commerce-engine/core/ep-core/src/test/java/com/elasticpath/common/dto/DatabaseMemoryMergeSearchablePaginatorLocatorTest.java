...
public class DatabaseMemoryMergeSearchablePaginatorLocatorTest {
	...
	public void testFindItemsPassThrough() {
		...
		final Page<ItemModelFake> inputPage = new PaginatorImpl.PageImpl<>(null, 0, 0, null);
	...
	public void testAddEndOfFirstPage() {
		...
		final Page<ItemModelFake> inputPage = new PaginatorImpl.PageImpl<>(paginator, 1, TEN, null);
	...
	public void testAddStartOfSecondPage() {
		...
		final Page<ItemModelFake> inputPage = new PaginatorImpl.PageImpl<>(paginator, 1, TEN, null);
		final Page<ItemModelFake> inputPage2 = new PaginatorImpl.PageImpl<>(paginator, 2, TEN, null);
