...
public class CartOrderServiceImplTest {
	...
	private static final String NAMED_QUERY_CART_ORDER_BY_STORECODE_AND_GUID = "CART_ORDER_BY_STORECODE_AND_GUID";
	...
	public void ensureSanitationAndPersistenceOfRetrievedCartOrder() {
		context.checking(new Expectations() {
			{
				oneOf(persistenceEngine).retrieveByNamedQuery(NAMED_QUERY_CART_ORDER_BY_STORECODE_AND_GUID, STORE_CODE, CART_ORDER_GUID);
