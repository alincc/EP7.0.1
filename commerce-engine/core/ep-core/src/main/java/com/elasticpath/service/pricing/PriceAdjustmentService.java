...
public interface PriceAdjustmentService {
	 ...
	 */
	@Deprecated
	Collection<PriceAdjustment> findAllAdjustmentsOnBundle(String plGuid, ProductBundle bundle);
	 ...
	 */
	Map<String, PriceAdjustment> findByPriceListAndBundleAsMap(String priceListGuid, ProductBundle bundle);
