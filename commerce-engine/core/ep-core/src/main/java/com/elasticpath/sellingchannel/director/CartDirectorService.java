...
public interface CartDirectorService {
	 ...
	 */
	ShoppingCart addItemToCart(ShoppingCart shoppingCart, ShoppingItemDto dto);
	 ...
	 *
	 * @param shoppingCart {@code ShoppingCart}
	 * @param doomedItemIds the ids of the cart item that should be removed
	 *
	 * @return the updated {@link ShoppingCart}
	 */
	ShoppingCart removeItemsFromCart(ShoppingCart shoppingCart, Long... doomedItemIds);
	 ...
	 */
	ShoppingCart moveItemFromWishListToCart(ShoppingCart shoppingCart, ShoppingItemDto dto, String wishlistLineItemGuid);
	 ...
	 * @return the shopping cart updated
	 */
	ShoppingItem moveItemFromCartToWishList(ShoppingCart shoppingCart, String cartLineItemGuid);
