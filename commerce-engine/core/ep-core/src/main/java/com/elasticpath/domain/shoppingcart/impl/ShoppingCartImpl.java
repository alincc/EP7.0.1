...
public class ShoppingCartImpl extends AbstractEpDomainImpl implements ShoppingCart, ShoppingCartPricingSnapshot,
	 ...
	 */
	private final Collection<String> notPurchasableCartItemSkus = new HashSet<>();
	...
	public boolean hasRecurringPricedShoppingItems() {
		return Iterables.any(
				Lists.transform(getCartItems(), new Function<ShoppingItem, ShoppingItemPricingSnapshot>() {
					@Override
					public ShoppingItemPricingSnapshot apply(final ShoppingItem input) {
						return getShoppingItemPricingSnapshot(input);
					}
				}), getShoppingItemHasRecurringPricePredicate());
	}
	 ...
	 */
	protected class ImmutableShippingPricingSnapshot implements ShippingPricingSnapshot {
