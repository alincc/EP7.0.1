...
public class WishListServiceImpl implements WishListService {
	...
	@Override
	public ShoppingItem addProductSku(final WishList wishList, final Store store, final String productSku) {
		...
		ShoppingItem shoppingItem = addItem(wishList, item);
		save(wishList);
		return shoppingItem;
	}
	...
	@Override
	public ShoppingItem addItem(final WishList wishList, final ShoppingItem item) {
		ShoppingItem existingItem = getExistingItem(wishList, item);
		if (existingItem != null) {
			return existingItem;
		}
		return wishList.addItem(item);
	}
