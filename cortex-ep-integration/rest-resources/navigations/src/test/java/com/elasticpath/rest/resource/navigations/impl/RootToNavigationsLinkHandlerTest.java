...
public class RootToNavigationsLinkHandlerTest {
	...
	@InjectMocks
	RootToNavigationsLinkHandler classUnderTest;

	@Test
	public void testToIdentifiers() throws Exception {
		...
		assertThat(actualIdentifier, Matchers.instanceOf(NavigationsIdentifier.class));
		NavigationsIdentifier typedIdentifier = (NavigationsIdentifier) actualIdentifier;
