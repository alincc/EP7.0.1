 ...
 */
public class NewAccountRegistrationActionPrototype implements NewAccountRegistrationFormResource.Submit {
	...
	@Override
	public Single<ProfileIdentifier> onSubmit() {
		...
		return repository.update(registrationEntity, profileIdentifier)
				.andThen(Single.just(profileIdentifier));
	}
}
