...
/**
 * Test for class {@link DefaultShippingAddressLookupImpl}.
 */
public final class DefaultShippingAddressLookupImplTest {
	...
	private final DefaultShippingAddressLookupImpl lookup = new TestDefaultShippingAddressLookupImpl(mockLookupStrategy);
	...
	/**
	 * A test implementation of {@link DefaultShippingAddressLookupImpl}.
	 */
	private class TestDefaultShippingAddressLookupImpl extends DefaultShippingAddressLookupImpl implements DefaultAddressLookup {
		 ...
		 */
		TestDefaultShippingAddressLookupImpl(final DefaultAddressLookupStrategy defaultShippingAddressLookupStrategy) {
			super(defaultShippingAddressLookupStrategy, resourceOperationContext);
		}
	}
}
