...
public class RootToSearchesLinkHandlerTest {
	...
	@InjectMocks
	RootToSearchesLinkHandler classUnderTest;
	...
	public void testToIdentifiers() {
		...
		assertThat(actualIdentifier, Matchers.instanceOf(SearchesIdentifier.class));
		SearchesIdentifier typedIdentifier = (SearchesIdentifier) actualIdentifier;
