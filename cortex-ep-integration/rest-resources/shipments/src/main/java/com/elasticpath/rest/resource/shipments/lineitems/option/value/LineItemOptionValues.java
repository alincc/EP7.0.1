 ...
 */
package com.elasticpath.rest.resource.shipments.lineitems.option.value;
...
@PathParam(LineItemOptionValues.URI_PART)
public @interface LineItemOptionValues {

	/**
	 * The string name of the uri part, useful for constructing URIs.
	 */
	String URI_PART = "values";
