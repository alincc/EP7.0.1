...
public class DeleteLineItemsPrototype implements WishlistLineItemsResource.Delete {
	 ...
	 */
	@Inject
	public DeleteLineItemsPrototype(@UriPart(WishlistIdentifier.WISHLIST_ID) final IdentifierPart<String> wishlistIdentifier,
	...
	public Completable onDelete() {
		return repository.deleteAll(WishlistIdentifier.builder()
