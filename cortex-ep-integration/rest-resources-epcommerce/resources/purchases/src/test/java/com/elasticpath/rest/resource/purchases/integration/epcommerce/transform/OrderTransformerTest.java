...
/**
 * The test of {@link OrderTransformer}.
 */
...
public class OrderTransformerTest {
	...
	public void testTransformToDomain() {
		orderTransformer.transformToDomain(null);
	}

	/**
	 * Tests {@link OrderTransformer#transformToEntity(Object)}.
	 */
	@Test
	public void testTransformToEntity() {
		...
		PurchaseEntity purchaseEntity = orderTransformer.transformToEntity(domainOrder, locale);
