...
public class CustomerSessionRepositoryImpl implements CustomerSessionRepository {
	...
	public CustomerSessionRepositoryImpl(
			...
			@Named("sessionPriceListLifecycle")
			final SessionPriceListLifecycle sessionPriceListLifecycle,
			@Named("storeRepository")
			final StoreRepository storeRepository,
			@Named("customerSessionTagSetFactory")
			final CustomerSessionTagSetFactory tagSetFactory) {
