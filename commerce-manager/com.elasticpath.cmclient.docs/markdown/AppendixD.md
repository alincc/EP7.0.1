...
> **Note**: The apostrophe in d&#39;accessoires must be preceded by a backslash. Whenever a string contains this character, it must be escaped with a backslash, otherwise it will be interpreted as the end of the string and cause a parsing error when the query is validated.
