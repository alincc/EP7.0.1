...
var EPTest = (function () {
    ...
    var
        ...
        _mapWidgetIdToTestId = function (widgetId, encodedId, widgetType) {
            ...
            try {
                ...
                if (typeof rapWidget !== "undefined") {
                    ...
                    if (rwtQuery) {
                        rwtQuery.attr(AUTOMATION_ID, _getIdFromMap(encodedId));
        ...
        _overrideButtonSetText = function () {
            ...
            if (typeof(pr.setText) !== "undefined" &&
                ...
                pr.setText = function (value) {
                    var applyAutomationIds = function (widget, text) {
                        var decodedText = _removeTestSequence(text);
                        widget.setText_button_original(decodedText);
                        widget.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(text));
                        widget.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                    };

                    if (_getIdFromMap(value)) {
                        applyAutomationIds(this, value);
                    }
                    else {
                        _requestMaps();
                        applyAutomationIds(this, value);
        ...
        _overrideToolItemSetToolTipText = function () {
            ...
            var proto = _findParentProtoTypeForFunction(rwt.widgets.ToolItem.prototype, "setToolTipText");
            if (typeof(proto.setToolTipText) !== "undefined" &&
                typeof(proto.setToolTipText_toolItem_original) === "undefined") {
                proto.setToolTipText_toolItem_original = proto.setToolTipText;
                proto.setToolTipText = function (value) {
                    if (value) {
                        var decodedText = _removeTestSequence(value);
                        this.setToolTipText_toolItem_original(decodedText);
                        this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                        this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                    }
                };
            }
        },
        ...
        _overrideWidgetSetToolTipText = function () {
                    ...
                    if (typeof(proto.setToolTipText) !== "undefined" &&
                        ...
                        proto.setToolTipText = function (value) {
                            if (value) {
                                var decodedText = _removeTestSequence(value);
                                this.setToolTipText_Widget_original(decodedText);
                            }
                        };
                    }
                },
        ...
        _overrideBasicTextSetValue = function () {
            ...
            if (typeof(pr.setValue) !== "undefined" &&
                ...
                pr.setValue = function (value) {
                    var decodedText = value;
                    if(value.includes(BEGINNING_ENCODING_MARKER) || value.includes(END_ENCODING_MARKER)) {
                        decodedText = _removeTestSequence(value);
                        this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                        if (this.getHtmlAttribute(ATTRIBUTE_WIDGET_ID) === "") {
                            this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                        }
                    }
                    this.setValue_BasicText_original(decodedText);
                };
            }
        },
        ...
        _overrideWindowsetCaption = function () {
            ...
            if (typeof(pr.setCaption) !== "undefined" &&
                ...
                pr.setCaption = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this.setCaption_Window_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideBasicButtonSetText = function () {
            ...
            if (typeof(pr.setText) !== "undefined" &&
                ...
                pr.setText = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this.setText_BasicButton_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideGridColumnSetText = function () {
            ...
            if (typeof(pr.setText) !== "undefined" &&
                ...
                pr.setText = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this.setText_GridColumn_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideGroupSetLegend = function () {
            ...
            if (typeof(pr._setLegend) !== "undefined" &&
                ...
                pr._setLegend = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this._setLegend_Group_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideLabelSetText = function () {
            ...
            if (typeof(pr.setText) !== "undefined" &&
                ...
                pr.setText = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this.setText_Label_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideMenuItemSetText = function () {
            ...
            if (typeof(pr.setText) !== "undefined" &&
                ...
                pr.setText = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this.setText_MenuItem_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideToolItemSetText = function () {
            ...
            if (typeof(pr.setText) !== "undefined" &&
                ...
                pr.setText = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this.setText_ToolItem_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideCTabItemSetText = function () {
            ...
            if (typeof(pr.setText) !== "undefined" &&
                typeof(pr.setText_CTabItem_original) === "undefined") {
                pr.setText_CTabItem_original = pr.setText;
                pr.setText = function (value) {
                    var decodedText = _removeTestSequence(value);
                    this.setText_CTabItem_original(decodedText);
                    this.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(value));
                    this.setHtmlAttribute(ATTRIBUTE_WIDGET_ID, decodedText);
                };
            }
        ...
        _overrideHyperlinksetText = function(){
            ...
            if (typeof(pr.setText) !== "undefined" &&
                typeof(pr.setText_Hyperlink_original) === "undefined") {
                pr.setText_Hyperlink_original = pr.setText;
                pr.setText = function (value) {

                    var applyAutomationIds = function (widget, text) {
                        var decodedValue = _removeTestSequence(text);
                        widget.setText_Hyperlink_original(decodedValue);
                        widget.setHtmlAttribute(AUTOMATION_ID, _getIdFromMap(text));
        ...
        _overrideSetAppearances = function () {
            ...
            if (!_override_called) {
                ...
                _overrideToolItemSetToolTipText();
                ...
                if (row && row.$el && row.$cellLabels && row.$cellLabels.length > 0) {
                    ...
                    row.$cellLabels.forEach(function (cellLabel, columnNum) {
                        if (cellLabel) {
                            ...
                            cellLabel.attr(AUTOMATION_ID, _getIdFromMap(text));
