...
public class ReportingPerspectiveFactory implements IPerspectiveFactory {
	...
	private static final float THREE_QUARTER_RATIO = 0.75f;
	...
	public void createInitialLayout(final IPageLayout layout) {
		...
		layout.addView(ReportingNavigationView.VIEW_ID, IPageLayout.LEFT, QUARTER_RATIO, editorArea);
		...
		IFolderLayout right = layout.createFolder("right", IPageLayout.RIGHT, THREE_QUARTER_RATIO, editorArea); //$NON-NLS-1$
