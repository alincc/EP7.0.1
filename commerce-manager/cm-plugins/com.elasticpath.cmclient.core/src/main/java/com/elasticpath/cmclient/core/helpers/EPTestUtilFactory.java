...
public class EPTestUtilFactory {
	...
	private static class NoOpEpTestUtil implements TestIdUtil {
		...
		@Override
		public void setTestIdsToToolBarManagerWithStyleForPagination(final IToolBarManager toolBarManager,
				final int beginningOfPagination, final String toolBarId) {
			LOG.trace(NO_OP);
		}
