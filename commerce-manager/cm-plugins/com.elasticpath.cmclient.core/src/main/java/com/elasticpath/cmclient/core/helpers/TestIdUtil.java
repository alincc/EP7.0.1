...
public interface TestIdUtil {
	 ...
	 * @param testId the id to set.
	 */
	void setId(Widget widget, String testId);
	...
	/**
	 * Sets Test ids to tool bar manager.
	 * @param toolBarManager the toolbar manager.
	 * @param toolBarId the id.
	 */
	void setTestIdsToToolBarManager(IToolBarManager toolBarManager, String toolBarId);

	/**
	 * Sets test ids to tool bar manager with pagination.
	 * @param toolBarManager the toolbar manager.
	 * @param beginningOfPagination the pagination start.
	 * @param toolBarId the id.
	 */
	void setTestIdsToToolBarManagerWithStyleForPagination(IToolBarManager toolBarManager, int beginningOfPagination,
			String toolBarId);

	/**
	 * Sets test ids to trees.
	 * @param tree the tree.
	 * @param treeId the Test id.
	 */
	void setTestIdsToTreeAndItsItems(Tree tree, String treeId);
