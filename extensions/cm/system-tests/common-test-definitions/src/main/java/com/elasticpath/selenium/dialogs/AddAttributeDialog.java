...
public class AddAttributeDialog extends AbstractDialog {
	private static final String ADD_ATTRUBUTE_PARENT_CSS
	...
	public void enterAttributeKey(final String attributeKey) {
		clearAndType(getWaitDriver().waitForElementToBeVisible(By.cssSelector(ATTRUBUTE_KEY_INPUT_CSS)), attributeKey);
	}
	...
	public void enterAttributeName(final String attributeName) {
		clearAndType(getDriver().findElement(By.cssSelector(ATTRUBUTE_NAME_INPUT_CSS)), attributeName);
	}
	...
	public void clickCheckBox(final String checkBoxName) {
		...
		getDriver().findElement(By.xpath(String.format(CHECK_BOX_XPATH, checkBoxfieldName))).click();
	}
	...
	public void clickAddButton() {
		getDriver().findElement(By.cssSelector(ADD_BUTTON_CSS)).click();
