...
public class CreateCategoryWizard extends AbstractWizard {
	...
	public void enterCategoryCode(final String categoryCode) {
		clearAndType(getWaitDriver().waitForElementToBeVisible(By.cssSelector(CATEGORY_CODE_INPUT_CSS)), categoryCode);
	}
	...
	public void enterCategoryName(final String categoryName) {
		clearAndType(getDriver().findElement(By.cssSelector(CATEGORY_NAME_INPUT_CSS)), categoryName);
	}
	...
	public void enterCurrentEnableDateTime() {
		getDriver().findElement(By.cssSelector(ENABLE_DATE_TIME_CALENDAR_ICON_CSS)).click();
		getWaitDriver().waitForPageLoad();
		getWaitDriver().waitForElementToBeClickable(By.cssSelector(CALENDAR_OK_BUTTON_CSS)).click();
	}
	...
	public void checkStoreVisibleBox() {
		getWaitDriver().waitForElementToBeClickable(By.cssSelector(STORE_VISIBLE_CHECKBOX_CSS)).click();
		getWaitDriver().waitForPageLoad();
	}
	...
	public EditLongTextAttributeDialog clickEditAttributeButtonLongText() {
		getWaitDriver().waitForElementToBeClickable(By.cssSelector(EDIT_ATTRIBUTE_VALUE_BUTTON_CSS)).click();
