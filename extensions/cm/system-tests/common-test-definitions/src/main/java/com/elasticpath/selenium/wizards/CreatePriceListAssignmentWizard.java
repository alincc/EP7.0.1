...
public class CreatePriceListAssignmentWizard extends AbstractWizard {
	...
	private static final String DESCRIPTION_INPUT = CREATE_PLA_PARENT_CSS + "div[widget-id='Description'] > textarea";
	 ...
	 *
	 * @param randomUUID String
	 */
	public void enterPriceListAssignmentName(final String randomUUID) {
		clearAndType(getWaitDriver().waitForElementToBeVisible(By.cssSelector(NAME_INPUT)), randomUUID);
	}
	...
	public void enterPriceListAssignmentDescription(final String descriptionText) {
		clearAndType(getWaitDriver().waitForElementToBeVisible(By.cssSelector(DESCRIPTION_INPUT)), descriptionText);
	}
