 ...
 */
public class EditCategoryTypeDialog extends AbstractDialog {

	private static final String ADD_CATEGORY_TYPE_PARENT_CSS
			= "div[automation-id='com.elasticpath.cmclient.catalog.CatalogMessages.CategoryTypeAddEditDialog_EditWindowTitle'][widget-type='Shell'] ";
	 ...
	 */
	public EditCategoryTypeDialog(final WebDriver driver) {
		super(driver);
	}
