...
public class CreateChangeSetDialog extends AbstractDialog {
	...
	public void enterChangeSetName(final String changeSetName) {
		clearAndType(getWaitDriver().waitForElementToBeVisible(By.cssSelector(CHANGE_SET_NAME_INPUT_CSS)), changeSetName);
	}
	...
	public void clickFinishButton() {
		getWaitDriver().waitForElementToBeClickable(By.cssSelector(FINISH_BUTTON_CSS)).click();
