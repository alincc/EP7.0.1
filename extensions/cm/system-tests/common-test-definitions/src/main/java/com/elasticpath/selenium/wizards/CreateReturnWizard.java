...
public class CreateReturnWizard extends AbstractWizard {
	...
	public void enterDigitalReturnQuantity(final int quantity, final String skuCode) {
		getWaitDriver().waitForElementToBeVisible(By.cssSelector(String.format(ELECTRONIC_RETURN_COLUMN_CSS, skuCode))).click();
		clearAndType(getDriver().findElement(By.cssSelector(ELECTRONIC_RETURN_COLUMN_INPUT_CSS)), String.valueOf(quantity));
	}
	...
	public void enterPhysicalReturnQuantity(final int quantity, final String skuCode) {
		getDriver().findElement(By.cssSelector(String.format(PHYSICAL_RETURN_COLUMN_CSS, skuCode))).click();
		clearAndType(getDriver().findElement(By.cssSelector(PHYSICAL_RETURN_COLUMN_INPUT_CSS)), String.valueOf(quantity));
	}
