...
public class CreateCatalogDialog extends AbstractDialog {
	...
	public void enterCatalogCode(final String catalogCode) {
		clearAndType(getWaitDriver().waitForElementToBeVisible(By.cssSelector(CATALOG_CODE_INPUT_CSS)), catalogCode);
	}
	...
	public void enterCatalogName(final String catalogName) {
		clearAndType(getDriver().findElement(By.cssSelector(CATALOG_NAME_INPUT_CSS)), catalogName);
	}
