...
public class UsersResultPane extends AbstractPageObject {
	private static final String CREATE_USER_BUTTON_XPATH = "div[widget-id='Create User'][widget-type='ToolItem'][seeable='true']";
	...
	public CreateUserDialog clickCreateUserButton() {
		getWaitDriver().waitForElementToBeClickable(By.cssSelector(CREATE_USER_BUTTON_XPATH)).click();
