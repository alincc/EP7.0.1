...
public class CatalogPromotionEditor extends AbstractPageObject {
	...
	public void enterCurrentExpirationDateTime() {
		getWaitDriver().waitForElementToBeClickable(By.cssSelector(OVERVIEW_LABEL_CSS)).click();
		...
		getWaitDriver().waitForElementToBeClickable(By.cssSelector(EXPIRATION_CALENDAR_ICON_CSS)).click();
		getWaitDriver().waitForPageLoad();
		getWaitDriver().waitForElementToBeClickable(By.xpath(CALENDAR_OK_BUTTON_XPATH)).click();
	}
	...
	public void disableCartPromotion() {
		getDriver().findElement(By.cssSelector(EXPIRATION_CALENDAR_ICON_CSS)).click();
		getWaitDriver().waitForPageLoad();
		getWaitDriver().waitForElementToBeClickable(By.xpath(CALENDAR_OK_BUTTON_XPATH)).click();
	}
}
