...
Feature: Can retrieve promotions pricing on cart line ltem 
  ...
  so that the customer can see the resulting list price and purchase price
  ...
  Scenario: Item with sale price and no promotions
	...
	And I can follow the price link
	Then the list-price has fields amount: 8.0, currency: CAD and display: $8.00
  ...
  Scenario: Item with sale price and catalog promotion
	...
	And I can follow the price link
	Then the list-price has fields amount: 7.2, currency: CAD and display: $7.20
  ...
  Scenario: Item with sale price and tiered pricing
	...
	And I can follow the price link
	Then the list-price has fields amount: 7.0, currency: CAD and display: $7.00
