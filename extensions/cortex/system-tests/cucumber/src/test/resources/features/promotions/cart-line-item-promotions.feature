...
Feature: Cart Line Item Promotions
  ...
  Background:
	...
	| productTriggeringFreeSkuPromo   | element:item:definition,element:appliedpromotions:element | productReceivingFreeSkuPromo | FreeSkuWhenYouBuyProductTriggeringFreeSkuPromo |
	...
	| CouponWillApply10PercentOffTheProductWith10PercentCoupon | Product With 10 Percent Off Coupon  | element:price,element:total|