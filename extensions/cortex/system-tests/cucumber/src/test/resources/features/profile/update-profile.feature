...
Feature: Update profile
  ...
  Scenario: Cannot update another user's profile
    ...
    When I authenticate as another user and attempt to update the other users profile family-name NEWFAMILY and given-name NEWGIVEN
