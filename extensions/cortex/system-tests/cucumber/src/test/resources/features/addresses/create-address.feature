...
Feature: Create Address
  ...
  Scenario Outline: Auto set default shipping and billing address
    ...
    When I create address with Country <COUNTRY>, Extended-Address <EXTENDED_ADDRESS>, Locality <LOCALITY>, Postal-Code <POSTAL_CODE>, Region <REGION>, Street-Address <STREET_ADDRESS>, Family-Name <FAMILY_NAME> and Given-Name <GIVEN_NAME>
  ...
  Scenario Outline: Cannot access or delete address of different user
    Given I have authenticated as a newly registered shopper
    And I get address form
    And I create address with Country <COUNTRY>, Extended-Address <EXTENDED_ADDRESS>, Locality <LOCALITY>, Postal-Code <POSTAL_CODE>, Region <REGION>, Street-Address <STREET_ADDRESS>, Family-Name <FAMILY_NAME> and Given-Name <GIVEN_NAME>
    And follow the response
    And save the address uri
    When I authenticate as a registered customer harry.potter@elasticpath.com with the default scope
    And attempt to access the other users address
    Then the HTTP status is not found
    And attempt to delete the other users address
  ...
  Scenario: Creating a duplicate address succeeds POST but doesn't create a new element
    Given I have authenticated as a newly registered shopper
    And I get address form
    And I create address with Country CA, Extended-Address Identical Address, Locality Vancouver, Postal-Code V5C1N2, Region BC, Street-Address 123 Broadway, Family-Name Customer and Given-Name Public Tester
    And I view my profile
    And I follow links addresses
    And there are 1 links of rel element
    When I create address with Country CA, Extended-Address Identical Address, Locality Vancouver, Postal-Code V5C1N2, Region BC, Street-Address 123 Broadway, Family-Name Customer and Given-Name Public Tester
