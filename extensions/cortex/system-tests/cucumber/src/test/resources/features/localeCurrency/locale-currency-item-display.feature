...
Feature: Display item name, currency, list and purchase price as per provided locale
  ...
  Scenario Outline: As a public user,I Perform item search with given locale to ensure correct item name and price are displayed
  ...
  Scenario Outline: As a Registered user, I Perform item search with given locale to ensure correct item name and price are displayed
