...
#      | catReleaseDate   | Release Date         | 1335078000000                                                            | 2012                                                                     |
      | catDescription   | Category Description | This category contains listing of all Games titles                       | This category contains listing of all Games titles                       |
      | catSubCategories | Subcategories        | Mobile Games, Video Games, 憤怒的小鳥, 怒っている鳥, नाराज पक्षियों, پرندگان عصبانی | Mobile Games, Video Games, 憤怒的小鳥, 怒っている鳥, नाराज पक्षियों, پرندگان عصبانی |
      | catReleased      | Released             | true                                                                     | True                                                                     |
      | catRating        | Category Rating      | 8.25                                                                     | 8.25                                                                     |
      | catTotalItems    | Total items          | 5                                                                        | 5                                                                        |
#      | catLastModified  | Last modified        | 1335813811000                                                            | 2012                                                                     |
      | catName          | Name                 | All <b><i>Games</i></b>                                                  | All <b><i>Games</i></b>                                                  |
  ...
  Scenario Outline: Node displays detail values based on scope locale
    Given I am logged into scope <ENGLISH_SCOPE> as a public user
  ...
  Scenario: Scope with no nodes has no navigation elements
    Given I am logged into scope rockjam as a public user
    When I follow the root navigations link
  ...
  Scenario: Featured items are in the specified order
    ...
    When open the element with field name of Movies
    And I follow links items
#    TODO: refactor this test step or the entire test to avoid navigation pages with "next" link
